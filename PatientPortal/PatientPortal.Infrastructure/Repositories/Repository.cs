        ...
        where TEntity : class, IEntity<TKey>
    {
            ...
            bool isTrackingOff = false)
        {
            ...
            if (orderBy != null)
            {
                ...
                if (isTrackingOff)
                    data = await result.AsNoTracking().ToListAsync().ConfigureAwait(false);
                else
        ...
        public virtual void Remove(TKey id)
        {
            ...
            if (entityToDelete != null) Remove(entityToDelete);
        }
        ...
        public void ModifyEntityStateToAdded<T>(T entity)
        {
            if (entity == null)
            {
        ...
        public virtual Task<TEntity?> GetOneAsync(
